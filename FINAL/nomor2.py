...
# for i in range(len(matriks_kofaktor)):
#        for j in range(len(matriks_kofaktor[0])):
#               matriks_0[j][i] = matriks_kofaktor[i][j]
# for matriks_kofaktor in matriks_0 :
#        print(matriks_kofaktor)
